...
D_INTERMEDIATE_COLOR="$_omb_prompt_gray"
D_USER_COLOR="$_omb_prompt_yellow"
D_SUPERUSER_COLOR="$_omb_prompt_yellow"
D_MACHINE_COLOR="$_omb_prompt_magenta"
D_DIR_COLOR="$_omb_prompt_cyan"
D_GIT_COLOR="$_omb_prompt_normal"
D_SCM_COLOR="$_omb_prompt_normal"
D_BRANCH_COLOR="$_omb_prompt_normal"
D_CHANGES_COLOR="$_omb_prompt_normal"
D_CMDFAIL_COLOR="$_omb_prompt_red"
D_VIMSHELL_COLOR="$_omb_prompt_normal"
...
prompt_git() {
  ...
  if git rev-parse --is-inside-work-tree &>/dev/null; then
    ...
    echo -e "${1}${branchName}${_omb_prompt_normal}$s "
  else
    return
  fi
}
